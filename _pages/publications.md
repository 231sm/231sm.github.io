...
- **Exploring Collaboration Mechanisms for LLM Agents: A Social Psychology View** \[[PAPER](https://arxiv.org/abs/2310.02124)\] <br>ArXiv, 2024; ICLR 2024 Workshop on LLM Agents. <br>Jintian Zhang, Xin Xu, Ningyu Zhang\#, Ruibo Liu, Bryan Hooi, ***Shumin Deng\#***. (**Corresponding** Author)
...
- **LLMs for Knowledge Graph Construction and Reasoning: Recent Capabilities and Future Opportunities** \[[PAPER](https://arxiv.org/abs/2305.13168)\] <br>ArXiv, 2024. <br>Yuqi Zhu, Xiaohan Wang, Jing Chen, Shuofei Qiao, Yixin Ou, Yunzhi Yao, ***Shumin Deng***, Huajun Chen, Ningyu Zhang. 
- **KnowPhish: Large Language Models Meet Multimodal Knowledge Graphs for Enhancing Reference-Based Phishing Detection** \[[PAPER](https://arxiv.org/abs/2403.02253)\] <br>ArXiv, 2024. <br>Yuexin Li, Chengyu Huang, ***Shumin Deng***, Mei Lin Lock, Tri Cao, Nay Oo, Bryan Hooi, Hoon Wei Lim. 
...
- **Editing Conceptual Knowledge for Large Language Models** \[[PAPER](https://arxiv.org/abs/2403.06259)\] <br>ArXiv, 2024. <br>Xiaohan Wang, Shengyu Mao, Ningyu Zhang, ***Shumin Deng***, Yunzhi Yao, Yue Shen, Lei Liang, Jinjie Gu, Huajun Chen. 
- **Detoxifying Large Language Models via Knowledge Editing** \[[PAPER](https://arxiv.org/abs/2403.14472)\] <br>ArXiv, 2024. <br>Mengru Wang, Ziwen Xu, Ningyu Zhang, Zekun Xi, ***Shumin Deng***, Yunzhi Yao, Qishen Zhang, Linyi Yang, Jindong Wang, Xing Xie, Huajun Chen. 
