...
- **Beyond Prompt Engineering: Robust Behavior Control in LLMs via Steering Target Atoms** \[[PAPER](https://arxiv.org/abs/2505.20322)\] <br>ACL 2025 (Oral). <br>Mengru Wang, Ziwen Xu, Shengyu Mao, ***Shumin Deng***, Zhaopeng Tu, Huajun Chen, Ningyu Zhang. 
...
- **KnowPhish: Large Language Models Meet Multimodal Knowledge Graphs for Enhancing Reference-Based Phishing Detection** \[[PAPER](https://arxiv.org/abs/2403.02253)\] <br>USENIX Security Symposium 2024. <br>Yuexin Li, Chengyu Huang, ***Shumin Deng***, Mei Lin Lock, Tri Cao, Nay Oo, Bryan Hooi, Hoon Wei Lim. 
