...
- **When Should Models Change Their Minds? Contextual Belief Management in Large Language Models** \[[PAPER](https://arxiv.org/abs/2605.30219)\] <br>EMNLP 2026. <br>Haoming Xu, Weihong Xu, Zongrui Li, Mengru Wang, Yunzhi Yao, Chiyu Wu, Jin Shang, Yu Gong, ***Shumin Deng\#***.
- **Exploring Autonomous Agentic Data Engineering for Model Specialization** \[[PAPER](https://arxiv.org/abs/2605.30407)\] <br>EMNLP 2026. <br>Yujie Luo, Xiangyuan Ru, Jingsheng Zheng, Jingjing Wang, Yuqi Zhu, Jintian Zhang, Runnan Fang, Kewei Xu, Ye Liu, Zheng Wei\#, Jiang Bian, Zang Li, ***Shumin Deng\#***.
- **EM²Mem: Event-Centric Multimodal Memory for Large Language Models** \[[PAPER](https://arxiv.org/abs/2609.00551)\] <br>EMNLP 2026, Findings. <br>Yijun Chen, Yaqi Zheng, Yanya Li, Boyi Xiao, Buqiang Xu, Shuofei Qiao, Jizhan Fang, Xinle Deng, Yunzhi Yao, Xuehai Wang, Liuxin Zhang, Hui Li, Huajun Chen, ***Shumin Deng\#***. 
...
- **OceanGym: A Benchmark Environment for Underwater Embodied Agents** \[[PAPER](https://arxiv.org/abs/2509.26536)\] <br>EMNLP 2026. <br>Yida Xue, Mingjun Mao, Xiangyuan Ru, Yuqi Zhu, Baochang Ren, Shuofei Qiao, Mengru Wang, ***Shumin Deng***, Xinyu An, Ningyu Zhang, Ying Chen, Huajun Chen. 
...
- **Unsupervised Skill Discovery for Agentic Data Analysis** \[[PAPER](https://arxiv.org/abs/2606.06416)\] <br>arXiv, 2026. <br>Zhisong Qiu, Kangqi Song, Shengwei Tang, Shuofei Qiao, Lei Liang, Huajun Chen, ***Shumin Deng\#***
- **SkillAdaptor: Self-Adapting Skills for LLM Agents from Trajectories** \[[PAPER](https://arxiv.org/abs/2606.01311)\] <br>arXiv, 2026. <br>Zhuoyun Yu, Xin Xie, Wuguannan Yao, Chenxi Wang, Lei Liang, Xiang Qi, ***Shumin Deng\#***.
- **Learning to Evaluate Before Improving: Automatic Rubric Induction for Automatic Research Agents** \[[PAPER](https://arxiv.org/abs/2608.31076)\] <br>arXiv 2026. <br>Xuehai Wang, Haowei Qin, Tongxin Liu, Junkai Li, Buqiang Xu, Jintian Zhang, Yijun Chen, Zirui Xue, ***Shumin Deng\#***
...
<!-- - **MobileMem: Evaluating Long-Horizon Memory for Language Agents in Real-World Mobile Environments** \[[PAPER]()\] <br>NLPCC 2026. <br>Xinle Deng, Yida Xue, Yijun Chen, Mingjun Mao, Ruobin Zhong, Buqiang Xu, Jizhan Fang, Haoming Xu, Tingwei Wu, Yajing Xu, Shumin Deng, Haofen Wang, Huajun Chen, Ningyu Zhang\#. -->
...
- **Automating Steering for Safe Multimodal Large Language Models** \[[PAPER](https://aclanthology.org/2025.emnlp-main.41/)\] <br>EMNLP 2025. <br>Lyucheng Wu, Mengru Wang, Ziwen Xu, Tri Cao, Nay Oo, Bryan Hooi, ***Shumin Deng\#***. 
- **Exploring Model Kinship for Merging Large Language Models** \[[PAPER](https://aclanthology.org/2025.findings-emnlp.32/)\] <br>EMNLP 2025, Findings. <br>Yedi Hu, Yunzhi Yao, Ningyu Zhang, Huajun Chen, ***Shumin Deng\#***.  
...
- **CaKE: Circuit-aware Editing Enables Generalizable Knowledge Learners** \[[PAPER](https://aclanthology.org/2025.emnlp-main.572/)\] <br>EMNLP 2025. <br>Yunzhi Yao, Jizhan Fang, Jia-Chen Gu, Ningyu Zhang, ***Shumin Deng***, Huajun Chen, Nanyun Peng. 
...
- **Normal vs. Adversarial: Salience-based Analysis of Adversarial Samples for Relation Extraction** \[[PAPER](https://dl.acm.org/doi/abs/10.1145/3502223.3502237)\] <br>IJCKG, 2021. **(IJCKG 2021 Best Short Paper Nomination)** <br> Luoqiu Li, Xiang Chen, Zhen Bi, Xin Xie, ***Shumin Deng***, Ningyu Zhang, Chuanqi Tan, Mosha Chen, Huajun Chen. 
